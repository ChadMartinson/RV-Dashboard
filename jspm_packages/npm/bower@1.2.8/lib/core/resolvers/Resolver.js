...
(function(process) {
  ...
  Resolver.prototype.hasNew = function(canonicalDir, pkgMeta) {
    ...
    if (pkgMeta) {
      ...
      promise = readJson(metaFile).spread(function(pkgMeta) {
  ...
  Resolver.prototype.resolve = function() {
    ...
    this._working = true;
    return this._createTempDir().then(this._resolve.bind(this)).then(this._readJson.bind(this, null)).then(function(meta) {
      return that._applyPkgMeta(meta).then(that._savePkgMeta.bind(that, meta));
    }).then(function() {
  ...
  Resolver.prototype._createTempDir = function() {
    return Q.nfcall(mkdirp, this._config.tmp).then(function() {
  ...
  Resolver.prototype._cleanTempDir = function() {
    ...
    return Q.nfcall(rimraf, tempDir).then(function() {
  ...
  Resolver.prototype._readJson = function(dir) {
    ...
    return readJson(dir, {assume: {name: this._name}}).spread(function(json, deprecated) {
      if (deprecated) {
  ...
  Resolver.prototype._applyPkgMeta = function(meta) {
    ...
    return removeIgnores(this._tempDir, meta.ignore).then(function() {
      return meta;
    });
  };
  Resolver.prototype._savePkgMeta = function(meta) {
    ...
    return Q.nfcall(fs.writeFile, path.join(this._tempDir, '.bower.json'), contents).then(function() {
