...
describe('PackageRepository', function() {
  ...
  beforeEach(function(next) {
    ...
    config = mout.object.deepMixIn({}, defaultConfig, {storage: {
    ...
    PackageRepository = proxyquire('../../lib/core/PackageRepository', {'./resolverFactory': resolverFactory});
  ...
  describe('.fetch', function() {
    ...
    it('should call the resolver hasNew method if an appropriate package was found in the resolve cache', function(next) {
      ...
      copy.copyDir(testPackage, tempPackage, {ignore: ['.git']}).then(function() {
