...
describe('GitResolver', function() {
  ...
  describe('.hasNew', function() {
    ...
    it('should be true when the resolution type is different', function(next) {
      ...
      resolver = create('foo');
      resolver.hasNew(tempDir).then(function(hasNew) {
    ...
    it('should be true when a higher version for a range is available', function(next) {
      ...
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/1.0.0', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/1.0.1']);
      };
      resolver = create('foo');
      resolver.hasNew(tempDir).then(function(hasNew) {
        expect(hasNew).to.be(true);
    ...
    it('should be true when a resolved to a lower version of a range', function(next) {
      ...
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/1.0.0']);
      };
      resolver = create('foo');
      resolver.hasNew(tempDir).then(function(hasNew) {
        expect(hasNew).to.be(true);
    ...
    it('should be false when resolved to the same tag (with same commit hash) for a given range', function(next) {
      ...
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/1.0.0', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/1.0.1']);
      };
      resolver = create('foo');
      resolver.hasNew(tempDir).then(function(hasNew) {
    ...
    it('should be true when resolved to the same tag (with different commit hash) for a given range', function(next) {
      ...
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/1.0.0', 'dddddddddddddddddddddddddddddddddddddddd refs/tags/1.0.1']);
      };
      resolver = create('foo');
      resolver.hasNew(tempDir).then(function(hasNew) {
        expect(hasNew).to.be(true);
  ...
  describe('._resolve', function() {
    ...
    it('should call the necessary functions by the correct order', function(next) {
      ...
      DummyResolver.prototype._findResolution = function() {
        ...
        return GitResolver.prototype._findResolution.apply(this, arguments).then(function(val) {
      ...
      DummyResolver.prototype._cleanup = function() {
        ...
        return GitResolver.prototype._cleanup.apply(this, arguments).then(function(val) {
      ...
      resolver.resolve().then(function() {
        expect(resolver.getStack()).to.eql(['before _findResolution', 'after _findResolution', 'before _checkout', 'after _checkout', 'before _cleanup', 'after _cleanup']);
        next();
      }).done();
    });
  ...
  describe('._findResolution', function() {
    ...
    it('should fail to resolve * if no tags/heads are found', function(next) {
      ...
      resolver = create('foo');
      resolver._findResolution('*').then(function() {
    ...
    it('should resolve "*" to the latest commit on master if a repository has no valid semver tags', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/heads/some-branch', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/some-tag']);
      };
      resolver = create('foo');
      resolver._findResolution('*').then(function(resolution) {
    ...
    it('should resolve "*" to the latest version if a repository has valid semver tags, ignoring pre-releases', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/0.1.0', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/v0.1.1', 'dddddddddddddddddddddddddddddddddddddddd refs/tags/0.2.0-rc.1']);
      };
      resolver = create('foo');
      resolver._findResolution('*').then(function(resolution) {
        expect(resolution).to.eql({
    ...
    it('should resolve "*" to the latest version if a repository has valid semver tags, not ignoring pre-releases if they are the only versions', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/0.1.0-rc.1', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/0.1.0-rc.2']);
      };
      resolver = create('foo');
      resolver._findResolution('*').then(function(resolution) {
        expect(resolution).to.eql({
    ...
    it('should resolve to a branch even if target is a range/version that does not exist', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/heads/3.0.0-wip', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/v0.1.1']);
      };
      resolver = create('foo');
      resolver._findResolution('3.0.0-wip').then(function(resolution) {
        expect(resolution).to.eql({
          type: 'branch',
          branch: '3.0.0-wip',
          commit: 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'
    ...
    it('should resolve to a tag even if target is a range that does not exist', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/1.0']);
      };
      resolver = create('foo');
    ...
    it('should resolve to the exact version if exists', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/0.8.1', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/0.8.1+build.1', 'dddddddddddddddddddddddddddddddddddddddd refs/tags/0.8.1+build.2', 'eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee refs/tags/0.8.1+build.3']);
      };
      resolver = create('foo');
    ...
    it('should fail to resolve if none of the versions matched a range/version', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/0.1.0', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/v0.1.1']);
      };
      resolver = create('foo');
    ...
    it('should resolve to the specified commit', function(next) {
      ...
      resolver = create('foo');
      resolver._findResolution('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb').then(function(resolution) {
        expect(resolution).to.eql({
          type: 'commit',
          commit: 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'
        });
    ...
    it('should resolve to the specified tag if it exists', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/some-tag']);
      };
      resolver = create('foo');
    ...
    it('should resolve to the specified branch if it exists', function(next) {
      var resolver;
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/heads/some-branch']);
      };
      resolver = create('foo');
      resolver._findResolution('some-branch').then(function(resolution) {
        expect(resolution).to.eql({
          type: 'branch',
          branch: 'some-branch',
          commit: 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'
  ...
  describe('._cleanup', function() {
    ...
    it('should remove the .git folder from the temp dir', function(next) {
      ...
      this.timeout(30000);
      copy.copyDir(path.resolve(__dirname, '../../../.git'), dst, {mode: 0777}).then(function() {
    ...
    it('should not fail if .git does not exist for some reason', function(next) {
      ...
      var dst = path.join(tempDir, '.git');
      resolver._tempDir = tempDir;
      resolver._cleanup().then(function() {
        expect(fs.existsSync(dst)).to.be(false);
        next();
      }).done();
    });
  ...
  describe('._savePkgMeta', function() {
    ...
    it('should add the version to the package meta if not present and resolution is a version', function(next) {
      ...
      resolver._tempDir = tempDir;
      resolver._savePkgMeta({name: 'foo'}).then(function() {
        return Q.nfcall(fs.readFile, path.join(tempDir, '.bower.json'));
      }).then(function(contents) {
        var json = JSON.parse(contents.toString());
  ...
  describe('#branches', function() {
    ...
    it('should resolve to an empty object if no heads are found', function(next) {
      ...
      GitResolver.branches('foo').then(function(branches) {
    ...
    it('should cache the result for each source', function(next) {
      GitResolver.refs = function(source) {
        ...
        return Q.resolve(['cccccccccccccccccccccccccccccccccccccccc refs/heads/master', 'dddddddddddddddddddddddddddddddddddddddd refs/heads/other-branch']);
      };
      GitResolver.branches('foo').then(function(branches) {
        expect(branches).to.eql({
          'master': 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        ...
        expect(branches).to.eql({'some-branch': 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'});
        return GitResolver.branches('bar');
      }).then(function(branches) {
        expect(branches).to.eql({'other-branch': 'dddddddddddddddddddddddddddddddddddddddd'});
        next();
      }).done();
    });
    it('should work if requested in parallel for the same source', function(next) {
      ...
      Q.all([GitResolver.branches('foo'), GitResolver.branches('foo')]).spread(function(branches1, branches2) {
  ...
  describe('#tags', function() {
    ...
    it('should resolve to an empty array if no tags are found', function(next) {
      ...
      GitResolver.tags('foo').then(function(tags) {
    ...
    it('should cache the result for each source', function(next) {
      GitResolver.refs = function(source) {
        if (source === 'foo') {
          return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/tags/0.2.1', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/some-tag']);
        }
        return Q.resolve(['cccccccccccccccccccccccccccccccccccccccc refs/tags/0.3.1', 'dddddddddddddddddddddddddddddddddddddddd refs/tags/some-tag']);
      };
      GitResolver.tags('foo').then(function(versions) {
        ...
        expect(tags).to.eql({'some-tag': 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb'});
        return GitResolver.tags('bar');
      }).then(function(tags) {
        expect(tags).to.eql({'some-tag': 'dddddddddddddddddddddddddddddddddddddddd'});
        next();
      }).done();
    });
    it('should work if requested in parallel for the same source', function(next) {
      ...
      Q.all([GitResolver.tags('foo'), GitResolver.tags('foo')]).spread(function(tags1, tags2) {
        expect(tags1).to.eql({
          '0.3.1': 'cccccccccccccccccccccccccccccccccccccccc',
          'some-tag': 'dddddddddddddddddddddddddddddddddddddddd'
        });
  ...
  describe('#versions', function() {
    ...
    it('should resolve to an empty array if no tags are found', function(next) {
      ...
      GitResolver.versions('foo').then(function(versions) {
    ...
    it('should resolve to an array of versions, ignoring invalid semver tags', function(next) {
      GitResolver.refs = function() {
        return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/heads/master', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/heads/some-branch', 'cccccccccccccccccccccccccccccccccccccccc refs/tags/0.2.1', 'dddddddddddddddddddddddddddddddddddddddd refs/tags/0.1.0', 'eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee refs/tags/v0.1.1', 'foo refs/tags/invalid', 'ffffffffffffffffffffffffffffffffffffffff refs/tags/', 'abbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags']);
      };
      GitResolver.versions('foo', true).then(function(versions) {
        expect(versions).to.eql([{
          version: '0.2.1',
          tag: '0.2.1',
          commit: 'cccccccccccccccccccccccccccccccccccccccc'
    ...
    it('should cache the result for each source', function(next) {
      GitResolver.refs = function(source) {
        if (source === 'foo') {
          return Q.resolve(['aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa refs/tags/0.2.1', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb refs/tags/0.1.0']);
        }
        return Q.resolve(['cccccccccccccccccccccccccccccccccccccccc refs/tags/0.3.1', 'dddddddddddddddddddddddddddddddddddddddd refs/tags/0.3.0']);
      };
      GitResolver.versions('foo').then(function(versions) {
    ...
    it('should work if requested in parallel for the same source', function(next) {
      ...
      Q.all([GitResolver.versions('foo'), GitResolver.versions('foo')]).spread(function(versions1, versions2) {
