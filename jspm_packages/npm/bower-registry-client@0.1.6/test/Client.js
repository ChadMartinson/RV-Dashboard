...
describe('RegistryClient', function() {
  ...
  describe('instantiating a client with custom options', function() {
    ...
    describe('cache', function() {
      beforeEach(function() {
        nock('https://bower.herokuapp.com:443').get('/packages/search/jquery').replyWithFile(200, __dirname + '/fixtures/search.json');
  ...
  describe('calling the lookup instance method with argument', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').get('/packages/jquery').reply(200, {
        name: 'jquery',
  ...
  describe('calling the lookup instance method with three registries', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').get('/packages/jquery').reply(404);
      nock('http://custom-registry.com').get('/packages/jquery').reply(200, {
        name: 'jquery',
        url: 'git://github.com/foo/bar'
      });
      nock('http://custom-registry2.com').get('/packages/jquery').reply(200, {
        name: 'jquery',
      ...
      this.registry = new RegistryClient({
        strictSsl: false,
        force: true,
        registry: {search: ['https://bower.herokuapp.com', 'http://custom-registry.com', 'http://custom-registry2.com']}
      });
    });
    it('should return entry type', function(next) {
      this.registry.lookup('jquery', function(err, entry) {
    ...
    it('should respect order', function(next) {
      this.registry._config.registry.search = ['https://bower.herokuapp.com', 'http://custom-registry2.com', 'http://custom-registry.com'];
      this.registry.lookup('jquery', function(err, entry) {
        expect(err).to.be(null);
        expect(entry).to.be.an('object');
  ...
  describe('calling the register instance method with argument', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').post('/packages', 'name=test-ba&url=git%3A%2F%2Fgithub.com%2Ftest-ba%2Ftest-ba.git').reply(201);
      this.pkg = 'test-ba';
  ...
  describe('calling the register instance method without arguments', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').post('/packages', 'name=&url=').reply(400);
    });
  ...
  describe('calling the search instance method with two registries', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').get('/packages/search/jquery').reply(200, []);
      nock('http://custom-registry.com').get('/packages/search/jquery').reply(200, [{
        name: 'jquery',
      ...
      this.registry = new RegistryClient({
        strictSsl: false,
        force: true,
        registry: {search: ['https://bower.herokuapp.com', 'http://custom-registry.com']}
      });
    });
    it('should return entry name', function(next) {
      var self = this;
  ...
  describe('calling the search instance method without argument', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').get('/packages/search/').reply(404);
    });
  ...
  describe('calling the list instance method', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').get('/packages').reply(200, [], {});
      this.registry._config.force = true;
    });
    it('should not return an error', function(next) {
  ...
  describe('calling the list instance method with two registries', function() {
    beforeEach(function() {
      nock('https://bower.herokuapp.com:443').get('/packages').reply(200, []);
      nock('http://custom-registry.com').get('/packages').reply(200, [{
        name: 'jquery',
        url: 'git://github.com/bar/foo.git'
      }]);
      this.registry = new RegistryClient({
