...
test('adding custom asserts ... ', function(t) {
  t.constructor.prototype.assertSurrounds = function(code, opts, expected) {
    ...
    this.equals(result, expected, util.format('%s: %s => %s', optsi, inspect(code), inspect(expected)));
    return this;
  };
  t.end();
});
test('types', function(t) {
  t.test('\n# Boolean', function(t) {
    ...
    t.assertSurrounds('return true; return false;', {'Boolean': {
        'false': '#:',
        _default: '$:%'
  ...
  t.test('\n# Identifier', function(t) {
    ...
    t.assertSurrounds('var a = 1; const b = 2;', {'Identifier': {
        'b': '#:',
        _default: '$:%'
      }}, 'var $a% = 1; const #b% = 2;');
    t.end();
  ...
  t.test('\n# Numeric', function(t) {
    ...
    t.assertSurrounds('return 1; return 2;', {'Numeric': {
        '2': '#:',
        _default: '$:%'
      }}, 'return $1%; return #2%;');
    t.end();
  ...
  t.test('\n# Punctuator', function(t) {
    ...
    t.assertSurrounds('return 2 * 2;', {'Punctuator': {
        '*': '#:',
        _default: '$:%'
      }}, 'return 2 #*% 2$;%');
    t.end();
  ...
  t.test('\n# String', function(t) {
    ...
    t.assertSurrounds('return "hello"; return "world";', {'String': {
        '"world"': '#:',
        _default: '$:%'
