...
test('\nfunction config, keywords', function(t) {
  var opts001 = {Keyword: {_default: function(s) {
        return '*' + s + '&';
      }}};
  t.test('\n# ' + inspect(opts001), function(t) {
    ...
    t.assertSurrounds(['function foo (bar) {', ' var a = 3;', ' return bar + a;', '}'].join('\n'), opts001, ['*function& foo (bar) {', ' *var& a = 3;', ' *return& bar + a;', '}'].join('\n'));
    t.end();
  });
  var opts002 = {Keyword: {
      'function': function(s) {
...
test('#\n function config - replacing', function(t) {
  var opts001 = {Keyword: {'var': function() {
        return 'const';
      }}};
  ...
  var opts002 = {Keyword: {_default: function() {
        return 'const';
      }}};
