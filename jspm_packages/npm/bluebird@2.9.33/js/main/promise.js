...
(function(process) {
  ...
  module.exports = function() {
    ...
    var PromiseArray = require("./promise_array")(Promise, INTERNAL, tryConvertToPromise, apiRejection);
    var CapturedTrace = require("./captured_trace")();
    var isDebugging = require("./debuggability")(Promise, CapturedTrace);
    var createContext = require("./context")(Promise, CapturedTrace, isDebugging);
    ...
    require("./progress")(Promise, PromiseArray);
    require("./method")(Promise, INTERNAL, tryConvertToPromise, apiRejection);
    require("./bind")(Promise, INTERNAL, tryConvertToPromise);
    require("./finally")(Promise, NEXT_FILTER, tryConvertToPromise);
    require("./direct_resolve")(Promise);
    require("./synchronous_inspection")(Promise);
    require("./join")(Promise, PromiseArray, tryConvertToPromise, INTERNAL);
    Promise.Promise = Promise;
    require("./map")(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
    require("./cancel")(Promise);
    require("./using")(Promise, apiRejection, tryConvertToPromise, createContext);
    require("./generators")(Promise, apiRejection, INTERNAL, tryConvertToPromise);
    ...
    require("./reduce")(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
    require("./settle")(Promise, PromiseArray);
    require("./some")(Promise, PromiseArray, apiRejection);
    require("./promisify")(Promise, INTERNAL);
    require("./any")(Promise);
    require("./each")(Promise, INTERNAL);
    require("./timers")(Promise, INTERNAL);
