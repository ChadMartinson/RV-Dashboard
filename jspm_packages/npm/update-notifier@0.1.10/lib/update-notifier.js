...
(function(process) {
  ...
  function UpdateNotifier(options) {
    ...
    this.updateCheckTimeout = typeof options.updateCheckTimeout === 'number' ? options.updateCheckTimeout : 20000;
    this.registryUrl = options.registryUrl || 'http://registry.npmjs.org/%s';
    this.callback = options.callback || function() {};
    if (!this.hasCallback) {
      this.config = new Configstore('update-notifier-' + this.packageName, {optOut: false});
    }
  }
  ...
  UpdateNotifier.prototype.checkNpm = function(cb) {
    ...
    request({
      url: url,
      json: true,
      timeout: this.updateCheckTimeout,
      proxy: proxyServer
